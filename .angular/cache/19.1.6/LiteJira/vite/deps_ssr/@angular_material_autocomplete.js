...
import {
  MAT_FORM_FIELD
} from "./chunk-DV2O6K56.js";
import "./chunk-YBZW4G3U.js";
import {
  TemplatePortal
...
var MatAutocomplete = class _MatAutocomplete {
  ...
  _activeOptionChanges = import_rxjs.Subscription.EMPTY;
...
var MatAutocompleteTrigger = class _MatAutocompleteTrigger {
  ...
  _viewportSubscription = import_rxjs.Subscription.EMPTY;
  /** Implements BreakpointObserver to be used to detect handset landscape */
  _breakpointObserver = inject(BreakpointObserver);
  _handsetLandscapeSubscription = import_rxjs.Subscription.EMPTY;
  /**
  ...
  _closeKeyEventStream = new import_rxjs.Subject();
  /**
  ...
  optionSelections = (0, import_rxjs.defer)(() => {
