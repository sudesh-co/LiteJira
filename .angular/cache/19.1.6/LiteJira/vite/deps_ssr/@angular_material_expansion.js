...
var CdkAccordion = class _CdkAccordion {
  ...
  _openCloseAllActions = new import_rxjs.Subject();
...
var CdkAccordionItem = class _CdkAccordionItem {
  ...
  _openCloseAllSubscription = import_rxjs.Subscription.EMPTY;
...
var MatExpansionPanel = class _MatExpansionPanel extends CdkAccordionItem {
  ...
  _inputChanges = new import_rxjs2.Subject();
...
var MatExpansionPanelHeader = class _MatExpansionPanelHeader {
  ...
  _changeDetectorRef = inject(ChangeDetectorRef);
  _parentChangeSubscription = import_rxjs2.Subscription.EMPTY;
  constructor() {
    ...
    panel.closed.pipe((0, import_operators.filter)(() => panel._containsFocus())).subscribe(() => this._focusMonitor.focusVia(this._element, "program"));
    if (defaultOptions) {
