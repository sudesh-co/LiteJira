...
var MatDrawer = class _MatDrawer {
  ...
  openedStart = this._animationStarted.pipe((0, import_operators.filter)(() => this.opened), (0, import_operators.mapTo)(void 0));
  /** Event emitted when the drawer has been closed. */
  _closedStream = this.openedChange.pipe((0, import_operators.filter)((o) => !o), (0, import_operators.map)(() => {
  }));
  /** Event emitted when the drawer has started closing. */
  closedStart = this._animationStarted.pipe((0, import_operators.filter)(() => !this.opened), (0, import_operators.mapTo)(void 0));
  ...
  constructor() {
    ...
    this._ngZone.runOutsideAngular(() => {
      ...
      (0, import_rxjs.fromEvent)(element, "keydown").pipe((0, import_operators.filter)((event) => {
...
var MatDrawerContainer = class _MatDrawerContainer {
  ...
  _watchDrawerToggle(drawer) {
    drawer._animationStarted.pipe((0, import_operators.takeUntil)(this._drawers.changes)).subscribe(() => {
      this.updateContentMargins();
      this._changeDetectorRef.markForCheck();
    });
    if (drawer.mode !== "side") {
