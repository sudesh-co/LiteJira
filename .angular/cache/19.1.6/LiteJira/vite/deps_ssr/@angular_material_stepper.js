...
import {
  MatIcon,
  MatIconModule
} from "./chunk-JRKZ3V3A.js";
import "./chunk-KGQJ477X.js";
import {
  CdkPortalOutlet,
  PortalModule,
  TemplatePortal
...
var MatStep = class _MatStep extends CdkStep {
  ...
  _isSelected = import_rxjs2.Subscription.EMPTY;
  ...
  _portal;
  ngAfterContentInit() {
    this._isSelected = this._stepper.steps.changes.pipe((0, import_operators2.switchMap)(() => {
      return this._stepper.selectionChange.pipe((0, import_operators2.map)((event) => event.selectedStep === this), (0, import_operators2.startWith)(this._stepper.selected === this));
...
var MatStepper = class _MatStepper extends CdkStepper {
  ...
  ngAfterContentInit() {
    ...
    this.steps.changes.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe(() => {
      this._stateChanged();
    });
    this._animationDone.pipe((0, import_operators2.takeUntil)(this._destroyed)).subscribe((event) => {
